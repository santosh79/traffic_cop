...
var recvdMsgCnt = 0;
var lastRecvdMsgCnt = 0;
var sentMsgCnt = 0;
var lastSentMsgCnt = 0;
var lastStatsTime = Date.now();

(function publishStats() {
  var diffRecvd = recvdMsgCnt - lastRecvdMsgCnt;
  var diffSent = sentMsgCnt - lastSentMsgCnt;
  var diffTime = Date.now() - lastStatsTime;
  lastRecvdMsgCnt = recvdMsgCnt;
  lastSentMsgCnt = sentMsgCnt;
  lastStatsTime = Date.now();
  console.log('recvd %d msgs and sent %d msgs in %d milliseconds', diffRecvd, diffSent, diffTime);
  setTimeout(publishStats, 1000);
}());
